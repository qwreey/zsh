...
if [[ "$ZSHP10K" == "true" ]]; then
	log "Clone romkatv/powerlevel10k"             ; git clone https://github.com/romkatv/powerlevel10k "$ZSHDIR/powerlevel10k" --depth 1
fi
log "Clone https://github.com/qwreey/quietline"                  ; git clone https://github.com/qwreey/quietline "$ZSHDIR/quietline-zsh-theme" --depth 1
log "Clone https://github.com/zsh-users/zsh-syntax-highlighting" ; git clone https://github.com/zsh-users/zsh-syntax-highlighting "$ZSHDIR/zsh-syntax-highlighting" --depth 1
log "Clone https://github.com/zsh-users/zsh-autosuggestions"     ; git clone https://github.com/zsh-users/zsh-autosuggestions "$ZSHDIR/zsh-autosuggestions" --depth 1
log "Clone https://github.com/zsh-users/zsh-autosuggestions"     ; git clone https://github.com/lincheney/fzf-tab-completion "$ZSHDIR/fzf-tab-completion" --depth 1
